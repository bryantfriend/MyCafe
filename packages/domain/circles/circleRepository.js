...
async function addCircleRsvp(circleId, rsvp, rsvpCount) {
  await updateDoc(doc(db, "cafeCircles", circleId), {
    rsvp: arrayUnion(rsvp),
    rsvpCount: rsvpCount
  });
}

export { addCircleRsvp, createCircle, getCircleById, listCircles, updateCircle };
